...
def make_figure_six(figure_path):

    mpl.rcParams['font.family'] = 'Helvetica'
    csfont = {'fontname': 'Helvetica'}
    letter_fontsize = 25
    label_fontsize = 17
    data_path = os.path.join(os.getcwd(), 'data', 'GSS')
    ...
    ax1.annotate(r'Sports Book',
                 xy=(2015, 0.095), xycoords='data', **csfont,
                 xytext=(2015, 0.097), fontsize=16, textcoords='data', )
    ax1.annotate(r'Baccarat',
                 xy=(2016, 0.052), xycoords='data', **csfont,
                 xytext=(2016, 0.055), fontsize=16, textcoords='data', )
    ax1.annotate(r'Blackjack',
                 xy=(2016, 0.0139), xycoords='data', **csfont,
                 xytext=(2016, 0.015), fontsize=16, textcoords='data', )
    ax2.hlines(0.5, ax1.get_xlim()[0], ax1.get_xlim()[1],
               linestyle=[(0, (10, 10, 10, 10))], color='k', linewidth=0.5, alpha=0.5)
    ax1.set_ylabel('IMV based on demographics\nrelative to prevalence', **csfont, fontsize=label_fontsize)
    ax2.set_ylabel('Proportion\nGOP', **csfont, fontsize=label_fontsize)
