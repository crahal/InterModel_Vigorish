from = here('data', 'GSS', 'GSSvars.csv')
vars<-read.csv(file=from, sep=",", header=TRUE)
from = here('data', 'GSS', 'GSS.csv')
...
out->out2
to = here('data', 'GSS', 'GSS_years.csv')
write.csv(do.call("rbind",out1)[, 1], file=to)
to = here('data', 'GSS', 'GSS_imv_output1.csv')
write.csv(do.call("rbind",out1)[, 3], file = to)
to = here('data', 'GSS', 'GSS_imv_output2.csv')
write.csv(do.call("rbind",out2)[, 3], to)
to = here('data', 'GSS', 'GSS_Z.csv')
