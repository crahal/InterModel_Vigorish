...
write.csv(out1a, file=here('data', 'HRS', 'out1a.csv'))
write.csv(out1b, file=here('data', 'HRS', 'out1b.csv'))
write.csv(out1c, file=here('data', 'HRS', 'out1c.csv'))
write.csv(out2c, file=here('data', 'HRS', 'out2c.csv'))
