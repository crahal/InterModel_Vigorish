...
read.dta(here('data', 'HRS', 'randhrs1992_2016v1_archive_STATA', 'randhrs1992_2016v1.dta'))->x
...
##grip & gait
load(here('data', 'HRS', 'grip_gait.Rdata'))
...
save(df,file=here('data', 'HRS', 'df.Rdata'))
...
L<-list()
##2004
read.dat.dct(dat=here('data', 'HRS', 'h04da', 'H04I_R.da'), dct=here('data', 'HRS', 'h04sta', 'H04I_R.dct'))->tmp
getvars(tmp,letter='J',wave=7)->L[['2004']]

##2006
read.dat.dct(dat=here('data', 'HRS', 'h06da', 'H06I_R.da'), dct=here('data', 'HRS', 'h06sta', 'H06I_R.dct'))->tmp
getvars(tmp,letter='K',wave=8)->L[['2006']]

##2008
read.dat.dct(dat=here('data', 'HRS', 'h08da', 'H08I_R.da'), dct=here('data', 'HRS', 'h08sta', 'H08I_R.dct'))->tmp
getvars(tmp,letter='L', wave=9)->L[['2008']]

##2010
read.dat.dct(dat=here('data', 'HRS', 'h10da', 'H10I_R.da'), dct=here('data', 'HRS', 'h10sta', 'H10I_R.dct'))->tmp
getvars(tmp, letter='M', wave=10)->L[['2010']]

##2012
read.dat.dct(dat=here('data', 'HRS', 'h12da', 'H12I_R.da'), dct=here('data', 'HRS', 'h12sta', 'H12I_R.dct'))->tmp
getvars(tmp, letter='N', wave=11)->L[['2012']]

##2014
read.dat.dct(dat=here('data', 'HRS', 'h14da', 'H14I_R.da'), dct=here('data', 'HRS', 'h14sta', 'H14I_R.dct'))->tmp
...
save(x, file=here('data', 'HRS', 'grip_gait.Rdata'))
write.csv(df, file=here('data', 'HRS', 'hrs_descriptives.csv'))
